...
$query_empleados = "SELECT Nombre, Apellidos FROM empleados WHERE Cargo = 'Cajero'";
$empleados = mysql_query($query_empleados, $saap) or die(mysql_error());
...
?>
        ...
        <div class="form-group">
        Nombre del empleado           
        <select name="NombreEmpleado" id="select6" class="form-control">
        <option required value=""> Seleccione el nombre del empleado</option>   
		  <?php
do {  
?>
            <option value="<?php echo $row_empleados['Nombre']." ".$row_empleados['Apellidos']?>"><?php echo $row_empleados['Nombre']." ".$row_empleados['Apellidos']?></option>
            <?php
